...
class Settings(BaseSettings):
    ...
    1. HIERARCHY: Root ('gov_01') -> AS_PRESIDENT -> President -> AS_MINISTER -> Minister (Role- THIS IS JUST THE ROLE (state/cabinet minister) NOT THE PERSON, ALWAYS FOLLOW THE AS_APPOINTED RELATION TO GET THE PERSON) -> AS_APPOINTED -> Person.
    ...
    6. SEARCH & DISCOVERY: Always prioritize searching entities by 'name' and relations by 'activeAt' if available. Use batch tools (for search, relations, and attributes) for efficiency. If a search returns >20 results, provide a summary and ask for focus rather than resolving every entity individually.
    """
