...
- Meetings Registry: 7 statutory bodies aggregated in `docs/src/data/ministry-health-meetings.json`
- 12 pages in `docs/docs/ministry-deep-dive/` (including meetings registry)
