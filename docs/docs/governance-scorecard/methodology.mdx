...
| **Total Powers** | 25% | Total number of enumerated powers across all statutory bodies. | Max = 27 (highest total powers in any health act). Score = raw/27. |
...
Proportion of the body's enumerated powers vs maximum across all bodies. Score = powersCount/15. Broader powers indicate a body was designed to be effective, not merely ceremonial. Highest DGQ weight.
