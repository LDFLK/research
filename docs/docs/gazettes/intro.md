...
The **Gazettes** project provides tools for extracting and processing Sri Lankan government gazette data. It consists of two main components that work together to transform raw gazette PDFs into structured, versioned data.
