...
```mermaid
flowchart LR
    ASA["Assisted Schools &<br/>Training Colleges Act<br/>No. 5 of 1960"] --> SUP["Supplementary<br/>Provisions Act<br/>No. 8 of 1961"]
    PEA["Public Examinations Act<br/>No. 25 of 1968"]
    ...
    click PEA "https://www.srilankalaw.lk/revised-statutes/volume-vi/965-public-examinations-act.html" "View Act (srilankalaw.lk)" _blank
    ...
    style PEA fill:#E65100,color:#fff
    style NLA fill:#5D4037,color:#fff
    style OLD fill:#EF5350,color:#fff
```

:::note
Three acts cataloged so far. The cross-reference network will grow as more Education acts are added (Education Ordinance, Universities Act, Pirivena Education Act, etc.).
:::
